...
<div class="container" >
    ...
    <a href="add_item.php" class="" >New Item</a>
    </button>
    <br><br>
        ...
        <tbody style="background-color:#E3E1D9">
            <?php
               ...
               while ($row = mysqli_fetch_assoc($result)) {
                ...
                <td>
                  <a href="edit_item.php?id=<?php echo $row['id']?>" class="link-dark " style="padding:8px">
                      <span class="glyphicon glyphicon-pencil "></span>
                  </a>
                  
                  <a href="delete_item.php?id=<?php echo $row['id']?>" class="link-dark">
